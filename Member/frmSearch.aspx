<%@ Page Language="VB" AutoEventWireup="false" CodeFile="frmSearch.aspx.vb" Inherits="Member_frmSearch" %>
...
<body style="width: 60%; border: 2px solid; margin: 0 auto; padding: 40px 20px 40px 20px;">
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <ajaxcontrol:autocompleteextender runat="server" id="acMemberFullName" targetcontrolid="txtSearch"
            servicemethod="getCategoryList" servicepath="../AutoCompleteWebServices.asmx" completionsetcount="1">
