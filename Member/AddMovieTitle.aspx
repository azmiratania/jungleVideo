<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AddMovieTitle.aspx.vb" Inherits="Member_Functions_AddMovieTitle" %>
    ...
    <table style="width: 100%;">
        <tr>
            <td style="vertical-align: top;" id="content">
                <br />
                <h2>
                    <asp:Label ID="lblMovieTitleHeader" runat="server" Text=""></asp:Label>
                </h2>
                <hr />
